    ...
    <div className="flex gap-4 items-start">
      ...
      <div className="flex-1 sketch-card p-4">
        <div className="flex items-center justify-between">
          ...
          <div className="font-mono text-sm text-[var(--sketch-text-dim)]">{date}</div>
        </div>
        <div className="font-mono text-sm mt-2 text-[var(--sketch-text-dim)]">{desc}</div>
        {certificate && (
          <div className="mt-2">
            <a href={certificate} target="_blank" rel="noreferrer" className="font-mono text-xs text-[var(--sketch-primary)] underline">Ver certificado</a>
          </div>
        )}
      </div>
    </div>
